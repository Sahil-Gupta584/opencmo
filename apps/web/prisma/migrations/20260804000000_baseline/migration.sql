-- CreateSchema
CREATE SCHEMA IF NOT EXISTS "opencmo";
...
-- CreateTable
CREATE TABLE "thread_opportunity" (
    "id" TEXT NOT NULL,
    "projectId" TEXT NOT NULL,
    "title" TEXT NOT NULL,
    "url" TEXT NOT NULL,
    ...
    CONSTRAINT "thread_opportunity_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "thread_opportunity" ADD CONSTRAINT "thread_opportunity_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "project"("id") ON DELETE CASCADE ON UPDATE CASCADE;
